...
#define MAXINSTRUCOES 100 // Número máximo de instruções
...
void imprimeVetorPrograma(Instrucao* vetorPrograma, int pc); // Imprime todas as instruções do programa a partir do pc (contador)
